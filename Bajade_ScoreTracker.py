...
window.geometry("600x400")  # Sets the window size to 600x400 pixels


# Labels
tk.Label(window, text="Name").grid(row=0, column=0, padx=15, pady=10, sticky="w")
tk.Label(window, text="Grade").grid(row=1, column=0, padx=15, pady=10, sticky="w")
...
# Buttons
tk.Button(window, text="Submit", command=save_to_excel, width=20, bg="#A4001B", fg="white").grid(row=3, column=0, columnspan=2, pady=10)
tk.Button(window, text="View Stored Data", command=show_data, width=20, bg="#A4001B", fg="white").grid(row=4, column=0, columnspan=2)
